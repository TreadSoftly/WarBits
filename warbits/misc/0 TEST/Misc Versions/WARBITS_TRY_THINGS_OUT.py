...
def attempt_full_cpu_usage() -> None:
    """
    Example placeholder for concurrency testing. Spawns a Pool
    just to demonstrate multi-core usage, then closes.
    """
    print("Attempting to utilize all available CPU cores in parallel.")
    with multiprocessing.Pool(processes=multiprocessing.cpu_count()) as pool:
        # We won’t actually map any large function here; it’s just a placeholder
        pass

def attempt_full_gpu_usage() -> None:
    """
    Example placeholder for concurrency testing using GPU if possible.
    (PyOpenGL, CUDA, etc. – not implemented here, just a stub.)
    """
    print("Attempting to leverage GPU if available (placeholder).")
...
###############################################################################
# 3. CURRENT VEHICLE & LOADOUT (Hardcoded)
###############################################################################
...
###############################################################################
# 4. VEHICLE CONFIG (Basic placeholders)
###############################################################################
...
###############################################################################
# 6. ADDITIONAL DATA (Potential concurrency expansions)
###############################################################################
...
###############################################################################
# 7. PHASES (Map for scenario. Start to help with concurrency tasks as well)
###############################################################################
phases_info = {
    "Approach": ("blue",   60),
    "Strafe":   ("orange", 50),
